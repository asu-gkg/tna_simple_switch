...
downlink_resubmit_table = get_table(ingress, "downlink_to_uplink_port_resubmit")
...
clear_table(downlink_resubmit_table, "downlink_to_uplink_port_resubmit")
...
program_downlink_to_uplink(downlink_resubmit_table, DOWNLINK_ECMP, SPINE1_MAC, SPINE2_MAC)
